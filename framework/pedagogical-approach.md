# KAMS Cycle 3 Pedagogical Framework: "Weaponizing the Gaps"
## December 1-19, 2025 | Research Foundation & Methodology

---

## Executive Summary

This curriculum implements **strategic interleaving** (Rohrer, 2012) to remediate Cycle 2 misconceptions while advancing pacing. Rather than explicit re-teaching, Cycle 3 content creates contexts where:

1. Incorrect mental models generate visible cognitive dissonance
2. Successful task completion requires retrieval of Cycle 2 concepts
3. Transfer is assessed through novel phenomena, not repeated prompts

**Research Foundation:**
- Rohrer (2012): Interleaving forces discrimination between similar concepts
- Roediger & Karpicke (2006): Retrieval practice > re-study for retention
- Smithsonian Science (2024): Three-dimensional assessment requires integrated SEP-DCI-CCC tasks
...
Each station targets specific practices:
...
Grade-specific progressions building on Cycle 2 foundations while introducing new content.
...
1. **Entry checkpoint:** Quick retrieval question from previous cycle
...
|-----------|-------|---------|
| NEW content | 2 | Cycle 3 learning targets |
| SPIRAL content | 2 | Cycle 2 retrieval practice |
| INTEGRATION | 1 | Requires both cycles |
...
## Misconception-Targeted Design

### Philosophy: "Weaponizing the Gaps"
Rather than re-teaching Cycle 2 content directly, we:
1. Design tasks where misconceptions cause visible failures
2. Create "misconception traps" with explicit distractors
3. Use immediate feedback to trigger cognitive revision
4. Spiral key concepts in novel contexts

### Implementation
- **Distractor Analysis:** Each MCQ includes common misconceptions as options
- **Explicit Labeling:** Questions tagged as (NEW), (SPIRAL), or (INTEGRATION)
- **Feedback Design:** Incorrect responses get targeted remediation text
...
- Chunked instructions (numbered steps, one action per line)
...
- Sentence frames: "The evidence shows... because..."
...
- **Simulations:** PhET (browser-based, Chromebook-friendly)
...
Smithsonian Science Education Center. (2024). *NGSS: Three-dimensional learning and assessment.*

Kaldaras, L., et al. (2021). Developing and validating NGSS-aligned learning progression. *Journal of Research in Science Teaching.*

---

*Framework Version 1.0 | December 2025 | KAMS Science*
